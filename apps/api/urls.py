...
from .views import UserDashboardData#, UserCategoriesList, UserIncomeList, UserExpenseList, UserReportsList

urlpatterns = [
    path('v1/user_dashboard_data/', UserDashboardData.as_view(), name='user_dashboard_data'),
]
